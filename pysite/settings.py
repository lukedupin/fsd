...
ADMINS = (
    ('Luke Dupin', 'lukedupin@gmail.com'),
)
...
DATABASES = {
    'default': {
        ...
        'NAME': '/var/www/fluidsoftwaredesigns.com/database.sqlite',                      # Or path to database file if using sqlite3.
...
STATICFILES_DIRS = (
    ...
    '/var/www/fluidsoftwaredesigns.com/website/static',
)
...
SECRET_KEY = '@i&amp;k#-n4x!p8erc3+(j_+a)%jvd@k*kcxhgar-sc8hj1$dqk@o'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/var/www/fluidsoftwaredesigns.com/website/views',
)
